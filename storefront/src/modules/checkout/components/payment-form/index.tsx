...
const PaymentForm = ({}: // setCardNumber,
// setExpiryDate,
// setSecurityCode,
// setNameOnCard,
any) => {
    ...
    <>
      <RadioGroup>
        <RadioGroup.Option
          ...
          value=""
          className={clx(
            "flex flex-col gap-y-2 text-small-regular cursor-pointer py-3 border-black border-2 rounded-t-md px-4 "
          )}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-x-4">
              <Radio value={""} />
              <div className="flex items-center gap-x-4">
                <MedusaRadio checked={false} />
              </div>
              <p className="text-base-regular">Credit card</p>
            </div>
      ...
      <div className="bg-[#f4f4f4] p-4 space-y-4 border-[#DDDDDD] border-b-2 rounded-b-md">
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            placeholder={""}
            className={`px-4 pt-5 pb-2 h-12 bg-white border-[1px] w-full rounded-md ${
            ...
            <div className="absolute top-0 right-4 h-full flex items-center">
              <div className="relative group">
                ...
                <div className="absolute text-center w-[10rem] bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-black text-white text-xs px-3 py-2 rounded shadow-lg">
                  ...
                  American Express cards have a 4-digit code located on the
                  front.
                </div>
              </div>
            </div>
