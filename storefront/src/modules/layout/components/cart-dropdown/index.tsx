      ...
      <Popover className="relative h-full">
        ...
        >
          <div className="relative">
            ...
            {totalItems !== 0 ? (
              <div className="absolute top-0 right-0 bg-[#44B865] rounded-full w-4 h-4 ">
                <h1 className=" text-xs text-white text-center leading-0 mt-[1px]">
                  {totalItems}
                </h1>
              </div>
            ) : null}
          ...
          >
            ...
            <div className="bg-[#f8f9fa] h-[100%] lg:h-[100vh] fixed top-0 right-0 bg-white cartDropdownWidth">
              ...
              {cartState && cartState.items?.length ? (
                <div className="bg-[#f8f9fa] cartchildHeight flex flex-col justify-between ">
